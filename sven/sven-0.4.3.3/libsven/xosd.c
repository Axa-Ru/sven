...
//const char *osd_default_font ="-misc-fixed-medium-r-semicondensed--*-*-40-*-c-*-*-*";
//const char* osd_default_font="adobe-helvetica-bold-r-*-*-10-*";
//const char* osd_default_font="-cronyx-helvetica-medium-r-normal-*-48-*-*-*-p-*-*";
const char* osd_default_font="-*-*-*-*-*-*-50-*-*-*-*-*-*";
#if 0
...
gchar* conv_locale_from_utf8 (gchar *s)
{
  if (! s)
     return NULL; 
  gsize bytes_written;
  ...
  case XOSD_printf:
    {
      ...
      char *string = conv_locale_from_utf8 (va_arg(a, char *));
